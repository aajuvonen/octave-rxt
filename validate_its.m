% Validator for ITS path loss model (Itse Tehty Säästömalli)
function loss_its = validate_its(d,h1,h2,f,p,q)
  p = 0;                                        % bool.  Polarisation, unaccounted for in ITS
  ...
  loss_its = path_loss + loss_dif + loss_sca;
endfunction